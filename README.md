...
- [x] Cálculo de autovalores e autovetores
- [x] Diagonalização de matrizes
...
```bash
gcc main.c menu.c sistemas.c transformacoes.c bases.c autovalores.c diagonalizacao.c matrizes.c arquivos.c util.c -o algebra
```
